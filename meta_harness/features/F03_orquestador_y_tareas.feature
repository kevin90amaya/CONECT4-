Feature: F03 Agente Orchestrator y Capa de Tareas
  ...
  Scenario: Creación física del dúo del agente Orchestrator
    ...
    Then deben existir los archivos "orchestator.md" y "orchestator.json" en dicho directorio
  ...
  Scenario: Interacción del Orquestador en su turno y modo interactivo
    ...
    When el Orquestador interactúa con el usuario
    Then debe presentar un menú interactivo con las opciones de "menuOptions"
    ...
    And al seleccionar la delegación y confirmar la acción, se debe realizar la transición al siguiente agente en "progress.md"
  ...
  Scenario: Ejecución del Orquestador cuando no es su turno
    ...
    When el Orquestador es invocado fuera de su turno
    Then debe informar en la consola o chat que no es el turno del orquestador
    And debe finalizar sin alterar el estado de "progress.md" ni del backlog
  ...
  Scenario: Caso límite - Intento de delegación sin tareas activas en el backlog
    ...
    When el Orquestador intenta delegar el turno al siguiente agente
    Then debe informar del error al usuario
  ...
  Scenario: Caso límite - Lectura de progress.md con formato inválido
    ...
    When el Orquestador lee el archivo de progreso
    Then debe informar de la anomalía de formato y abortar la ejecución o delegación inmediatamente
