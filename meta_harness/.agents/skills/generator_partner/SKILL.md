...
- ❌ NUNCA modifiques `meta_harness/state/pendings.md` o `session_handoff.md`.
- ✍️ DEBES actualizar el archivo `meta_harness/state/progress.md` al finalizar tu turno, registrando tus decisiones tomadas, recursos estudiados y estableciendo el `Siguiente Turno` en el pipeline.
