...
1. **Lectura de contexto:** Al ser invocado, lee tu propio archivo de contrato `git_agent.json`.
2.lee el archivo state/progress.md y fijate quien es el ultimo agente que edito progress.md 
...
al terminar simpre delega al orchestator